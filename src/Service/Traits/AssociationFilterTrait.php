...
trait AssociationFilterTrait
{
    ...
    private function applyCollectionFilter(QueryBuilder $qb, string $column, mixed $value, array $metadata): void
    {
        ...
        // This is essential for collection admin links generated by admin_collection_url(),
        // which passes the source entity's ID as the filter value. Without this, a developer
        // would have to add 'id' to every searchFields config for links to work.
        if (is_numeric($value)) {
